Pod::Spec.new do |m|
  ...
  m.source = { :git => 'https://github.com/lasseyls/mapbox-ios-sdk.git' }
  ...
  m.dependency 'SMCalloutView', :podspec => 'https://raw.github.com/lasseyls/calloutview/master/SMCalloutView.podspec'
